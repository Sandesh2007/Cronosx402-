              ...
              <div className="mb-3">
                <div className="group relative">
                  <button
                    ...
                    className="flex w-full items-center justify-between rounded-md p-2 transition-colors hover:bg-zinc-100 dark:hover:bg-zinc-700"
                ...
                {copied && (
                  <p className="mt-1 text-xs text-green-500">Address copied!</p>
                )}
              </div>
              <button
